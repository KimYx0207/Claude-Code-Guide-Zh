...
**子目录/文件**：settings.json
**职责**：团队统一配置
**入库策略**：必须入库


**子目录/文件**：settings.local.json
**职责**：个人本地配置
**入库策略**：禁止入库
...
**说明**：Anthropic API密钥
**获取方式**：console.anthropic.com


**Secret名称**：GITHUB_TOKEN
**说明**：GitHub Token
**获取方式**：自动提供（默认）
...
**特性**：安装复杂度
**GitHub Action**：低（配置文件）
**GitHub App**：中（OAuth流程）


**特性**：实时响应
**GitHub Action**：否（需要触发）
**GitHub App**：是（Webhook）
