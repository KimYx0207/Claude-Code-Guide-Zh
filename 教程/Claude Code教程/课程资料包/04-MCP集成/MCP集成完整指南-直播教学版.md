...
> 📌 **信息来源**：[MCP官方文档](https://modelcontextprotocol.io/) | [GitHub公告](https://github.com/modelcontextprotocol) | 验证日期：2025-12-19
...
| `claude mcp test` | 测试服务器连接 | `claude mcp test github` |
| `claude mcp restart` | 重启服务器 | `claude mcp restart github` |
...
| Sequential Thinking | `@modelcontextprotocol/server-sequentialthinking` | 顺序思考 |
| Puppeteer | `@modelcontextprotocol/server-puppeteer` | 浏览器自动化 |
| Brave Search | `@anthropic/mcp-server-brave-search` | 网页搜索 |
...
> 📌 **信息来源**：
> - [MCP官方文档](https://modelcontextprotocol.io/) | 验证日期：2025-12-19
> - [GitHub MCP Server仓库](https://github.com/modelcontextprotocol/servers) | 验证日期：2025-12-19
> - [Claude Code文档](https://code.claude.com/docs/en/mcp) | 验证日期：2025-12-19
