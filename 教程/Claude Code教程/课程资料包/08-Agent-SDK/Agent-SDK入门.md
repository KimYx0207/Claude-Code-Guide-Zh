...
**特性**：**使用方式**
**Claude Code CLI**：交互式终端或单命令
**Claude Agent SDK**：程序化调用


**特性**：**适合场景**
**Claude Code CLI**：日常开发、快速任务
**Claude Agent SDK**：自动化、集成、批处理


**特性**：**上下文管理**
**Claude Code CLI**：自动管理
**Claude Agent SDK**：开发者控制


**特性**：**并发能力**
**Claude Code CLI**：单会话
**Claude Agent SDK**：多代理并行


**特性**：**定制程度**
**Claude Code CLI**：配置文件
**Claude Agent SDK**：完全可编程
...
**要求项**：**操作系统**
**最低版本**：Windows 10/macOS 12/Ubuntu 20.04
**推荐版本**：最新稳定版
